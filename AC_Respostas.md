...
As recompensas são atribuídas quando o agente executa uma ação que efetivamente move um objeto da prateleira para uma caixa.
...
O print da execução que obteve esse resultado ótimo está abaixo. Foi adicionado, também, a impressão da data e hora no terminal para fins de validação do resultado.
![Print](print.jpeg)
